...
// Author contact info
function disto_extra_contact_info($contactmethods) {
...
add_filter('user_contactmethods', 'disto_extra_contact_info');
// Display author contact info
function disto_author_contact( $post_id ) {
?>
<ul class="jl-author-link clearfix">                                                          
<?php if ((get_the_author_meta('url')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('url')); ?>" target="_blank"><i class="fa fa-globe"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('email')) != ''){ ?>
<li><a href="mailto:<?php echo get_the_author_meta('email'); ?>" target="_blank"><i class="fa fa-envelope"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('linkedin')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('linkedin')); ?>" target="_blank"><i class="fa fa-linkedin-in"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('rss')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('rss')); ?>" target="_blank"><i class="fa fa-rss"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('pinterest')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('pinterest')); ?>" target="_blank"><i class="fa fa-pinterest-p"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('devianart')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('devianart')); ?>" target="_blank"><i class="fa fa-deviantart"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('dribble')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('dribble')); ?>" target="_blank"><i class="fa fa-dribbble"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('behance')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('behance')); ?>" target="_blank"><i class="fa fa-behance"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('youtube')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('youtube')); ?>" target="_blank"><i class="fa fa-youtube"></i></a></li>
<?php }?>                                
<?php if ((get_the_author_meta('instagram')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('instagram')); ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
<?php }?>                            
<?php if ((get_the_author_meta('twitter')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('twitter')); ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('facebook')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('facebook')); ?>" target="_blank"><i class="fa fa-facebook-f"></i></a></li>
<?php }?>
<?php if ((get_the_author_meta('googleplus')) != ''){ ?>
<li><a href="<?php echo esc_url(get_the_author_meta('googleplus')); ?>" target="_blank"><i class="fa fa-google-plus"></i></a></li>
<?php }?>
</ul>                                
<?php }?>
<?php
